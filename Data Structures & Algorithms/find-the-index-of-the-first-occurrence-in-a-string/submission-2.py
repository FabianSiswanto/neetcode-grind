    ...
    def strStr(self, haystack: str, needle: str) -> int:
        ...
        while cur < len(needle):
            if needle[cur] == needle[prev]:
                ...
                prev = lps[prev - 1] # length of prefix at before prev, revert
            else: # prev at 0
                lps[cur] = 0 # force to 0, move on
                cur += 1
        ...
        while i < len(haystack):
            if haystack[i] == needle[j]:
                ...
                j = lps[j - 1] # jump to index to check, skip match
            else:
